...
@Command("/lightoff")
@Component
public class LightOff extends BotCommand implements IBotCommand{

    protected LightOff(BotConfig config) throws YeelightSocketException {
        super(config);
    }

    @Override
    public void execute(Update update) throws YeelightResultErrorException, YeelightSocketException {
